...
public class SliderSettingsFragment extends PreferenceFragment
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        SwitchPreference sliderPreference = (SwitchPreference) findPreference(SLIDER_DISABLE_KEY);
        sliderPreference.setEnabled(true);
